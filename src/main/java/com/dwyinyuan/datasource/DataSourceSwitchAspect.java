package com.dwyinyuan.datasource;
...
public class DataSourceSwitchAspect {
    ...
    Logger log = LoggerFactory.getLogger(DataSourceSwitchAspect.class);

    @Pointcut("execution(* com.dwyinyuan.service.from..*.*(..))")
    public void db1Aspect() {
    }

    @Pointcut("execution(* com.dwyinyuan.service.to..*.*(..))")
